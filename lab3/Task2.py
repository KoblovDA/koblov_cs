...
def tree (size, x, y):
    ...
    circle (screen, dark_green, (x + 0.1*size, y - 0.9*size), 0.3*size)
    circle (screen, black, (x + 0.1*size, y - 0.9*size), 0.3*size, 1)

    circle (screen, dark_green, (x - 0.2*size, y - 0.6*size), 0.3*size)
    circle (screen, black, (x - 0.2*size, y - 0.6*size), 0.3*size, 1)

    circle (screen, dark_green, (x + 0.36*size, y - 0.6*size), 0.33*size)
    circle (screen, black, (x + 0.36*size, y - 0.6*size), 0.33*size, 1)

    
    circle (screen, dark_green, (x + 0.1*size, y - 0.4*size), 0.3*size)
    circle (screen, black, (x + 0.1*size, y - 0.4*size), 0.3*size, 1)
    
    circle (screen, dark_green, (x - 0.2*size, y - 0.2*size), 0.3*size)
    circle (screen, black, (x - 0.2*size, y - 0.2*size), 0.3*size, 1)

    circle (screen, dark_green, (x + 0.36*size, y - 0.2*size), 0.33*size)
    circle (screen, black, (x + 0.36*size, y - 0.2*size), 0.33*size, 1)
